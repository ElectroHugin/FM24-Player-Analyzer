; Inno Setup script for the FM24 Player Analyzer desktop app.
...
#define MyAppName "FM24 Player Analyzer"
#ifndef MyAppVersion
...
OutputDir=output
OutputBaseFilename=FM24PlayerAnalyzer-Setup-{#MyAppVersion}
Compression=lzma2
